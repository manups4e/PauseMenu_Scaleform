class com.rockstargames.PauseMenu.tabs.playerList.FriendItem
{
	var _label;
	var itemMC;
	var parentMC;
	...
	function setColour(hudColor, colorTabBool)
	{
		...
		this.itemMC._visible = this.isColour && this.type != com.rockstargames.PauseMenu.tabs.playerList.FriendItem.AS_OFFLINE;
		if (this.isColour)
		{
			if (this.type != com.rockstargames.PauseMenu.tabs.playerList.FriendItem.AS_OFFLINE)
			{
	...
	function set highlighted(_h)
	{
		...
		if (this.isColour)
		{
			...
			else if (this.type == com.rockstargames.PauseMenu.tabs.playerList.FriendItem.AS_ONLINE_DIFFERENT_SESSION)
			{
				__reg7 = _h ? 60 : 20;
				__reg10 = _h ? 60 : 30;
			}
			else if (this.type == com.rockstargames.PauseMenu.tabs.playerList.FriendItem.AS_ONLINE_IN_SESSION)
			{
				__reg7 = _h ? 100 : 20;
			}
			else if (this.type == com.rockstargames.PauseMenu.tabs.playerList.FriendItem.AS_ONLINE_DIFFERENT_MATCH)
			{
				__reg7 = _h ? 60 : 20;
				__reg10 = 60;
			}
