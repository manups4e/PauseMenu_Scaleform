class com.rockstargames.PauseMenu.tabs.playerList.SettingsList
{
	var _MC;
	var _parentMC;
	...
	function SettingsList(parent, offset, id)
	{
		...
		this.BodyMask = this._MC.attachMovie("pauseMenuColumnBody", "Body_settings", this._MC.getNextHighestDepth());
	...
	function AddItem(id, str, sub, enabled, blink, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13)
	{
		...
		item.itemMC.mouseCatcher.setupGenericMouseInterface(this.itemCount,this._id,item.onMouseEvent,[item]);
