class com.rockstargames.PauseMenu.header.Header
{
	...
	function SetHeaderTitle(title, description, isChallenge)
	{
		...
		__reg2._y = Math.max(-8, __reg10 - __reg2.headingTF.textHeight / 2);
	}
	...
	function ShiftCoronaDesc(shiftDesc, hideTabs)
	{
		...
		this.menubar._y = __reg4;
		var __reg2 = 0;
		while (__reg2 < this.menubar.menuItemList.length)
		{
	...
	function SetHeadingDetails(str1, str2, str3, isSingleplayer)
	{
		...
		if (isSingleplayer)
		{
			...
			__reg2.details1TF.text = "<font face=\'$Font2_cond_NOT_GAMERNAME\' size=\'" + 22 + "\'>" + str1.toUpperCase() + "</font>";
		}
		else
		{
			__reg2.details1condTF.text = "";
			__reg2.details1TF.text = "<font face=\'$Font2_cond_NOT_GAMERNAME\' size=\'" + 22 + "\'>" + str1 + "</font>";
		}
		...
		if (str2 != undefined)
		{
			...
			if (__reg7)
			{
				...
				__reg2.timeTF.text = "<font face=\'$Font2_cond_NOT_GAMERNAME\' size=\'" + 22 + "\'>" + __reg5 + "</font>";
				...
				__reg2.details2TF.text = "<font face=\'$Font2_cond_NOT_GAMERNAME\' size=\'" + 22 + "\'>" + __reg6 + "</font>";
			...
			{
				__reg2.details2TF.text = "<font face=\'$Font2_cond_NOT_GAMERNAME\' size=\'" + 22 + "\'>" + str2 + "</font>";
				__reg2.details2TF.autoSize = "left";
				__reg2.details2TF.wordWrap = false;
				__reg2.details2TF.multiline = false;
		...
		if (str3 != undefined)
		{
			__reg2.details3TF.text = "<font face=\'$Font2_cond_NOT_GAMERNAME\' size=\'" + 22 + "\'>" + str3 + "</font>";
