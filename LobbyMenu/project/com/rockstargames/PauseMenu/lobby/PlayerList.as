class com.rockstargames.PauseMenu.lobby.PlayerList
{
	var _MC;
	var _parentMC;
	...
	function PlayerList(parent, offset, id)
	{
		...
		this.BodyMask = this._MC.attachMovie("pauseMenuRightBody", "Body_players", this._MC.getNextHighestDepth(), {_x:this.OFFSET});
		...
		this.Footer = this._MC.attachMovie("Footer", "footer_players", this._MC.getNextHighestDepth());
	...
	function AddItem(id, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13)
	{
		...
		if (id == 0)
		{
			item = new com.rockstargames.PauseMenu.lobby.tabs.matchmaking.PlayerItem(this, this.scrollableContent, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13);
			item.itemMC._x = item.itemMC._x - 25;
		}
		else if (id == 1)
		{
			item = new com.rockstargames.PauseMenu.lobby.tabs.matchmaking.FriendItem(this, this.scrollableContent, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13);
		}
